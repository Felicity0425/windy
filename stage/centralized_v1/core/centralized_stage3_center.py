...
def process_frame(row: dict[str, Any], alpha: float, out_dir: Path, agent_mode: str = "none") -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    ground_center_payload = {
        ...
        "context_wind_observations": _record_group(C2_CONTEXT_WIND_RECORDS, "stage4_fusion_support_wind_observations", context_wind_records),
        ...
        "stage2_metadata_excerpt": {
            ...
            "wind_record_role_policy": meta.get("wind_record_role_policy"),
            "current_support_rows_excluded_from_wind_records": meta.get("current_support_rows_excluded_from_wind_records"),
            "current_label_rows_kept_in_wind_records": meta.get("current_label_rows_kept_in_wind_records"),
