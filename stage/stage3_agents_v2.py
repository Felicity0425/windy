...
def _resolve_stage3_output_dir() -> str:
    return os.environ.get(
        "WIND_STAGE3_OUTPUT_DIR",
        os.path.join(cfg.BASE_DIR, "stage3_output_v2"),
    )
...
def build_agents_for_frame(vox):
    ...
    vox_dir = os.path.join(_resolve_stage3_output_dir(), "agents")
