# CMA-RA Virtual Radial 3DVAR Proxy - 20260131123000
...
- Stage2 frame: `20260131123000`
- CMA time: `2026013112->2026013118` (`delta_hours=0.500`)
- CMA time method: `linear_qc`
- Stage2 npz: `/data/LFT-W02_data/pengxu/centralized_v1_output/stage2_full_v2/voxels/frame_20260131123000_multimodal.npz`
...
- NPZ: `/data/LFT-W02_data/pengxu/优化/stage4_cma_m1_light_demo_20260625/representative_cma_proxy/cma_ra_virtual_radial_3dvar_20260131123000.npz`
- sample CSV: `/data/LFT-W02_data/pengxu/优化/stage4_cma_m1_light_demo_20260625/representative_cma_proxy/cma_ra_virtual_radial_3dvar_20260131123000_sample.csv`

## Proxy Losses

| metric | value |
| --- | ---: |
| `loss_observation_fit_proxy` | 20.251595 |
| `loss_background_fit_proxy` | 0.079644 |
| `loss_stage4_sparse_prior_fit_proxy` | 0.000000 |
| `loss_virtual_radial_velocity_fit_proxy` | 0.045333 |
| `loss_smoothness_proxy` | 0.274674 |
| `loss_weak_horizontal_divergence_proxy` | 0.210660 |
| `loss_vertical_shear_proxy` | 2.095063 |
| `loss_boundary_background_proxy` | 0.005457 |
| `coverage_conf_positive_fraction` | 0.002101 |
| `iterations` | 6.000000 |
...
- Aircraft anchor records used: `59`; Stage4-like anchor hold-out excluded: `9`.
