# CMA-RA Virtual Radial 3DVAR Proxy - 20260211031200
...
- Stage2 frame: `20260211031200`
- CMA time: `2026021100->2026021106` (`delta_hours=3.200`)
- CMA time method: `linear_qc`
- Stage2 npz: `/data/LFT-W02_data/pengxu/centralized_v1_output/stage2_full_v2/voxels/frame_20260211031200_multimodal.npz`
...
- NPZ: `/data/LFT-W02_data/pengxu/优化/stage4_cma_m1_light_demo_20260625/representative_cma_proxy/cma_ra_virtual_radial_3dvar_20260211031200.npz`
- sample CSV: `/data/LFT-W02_data/pengxu/优化/stage4_cma_m1_light_demo_20260625/representative_cma_proxy/cma_ra_virtual_radial_3dvar_20260211031200_sample.csv`

## Proxy Losses

| metric | value |
| --- | ---: |
| `loss_observation_fit_proxy` | 30.572262 |
| `loss_background_fit_proxy` | 0.069816 |
| `loss_stage4_sparse_prior_fit_proxy` | 0.000000 |
| `loss_virtual_radial_velocity_fit_proxy` | 0.039191 |
| `loss_smoothness_proxy` | 0.252207 |
| `loss_weak_horizontal_divergence_proxy` | 0.173877 |
| `loss_vertical_shear_proxy` | 2.078990 |
| `loss_boundary_background_proxy` | 0.004508 |
| `coverage_conf_positive_fraction` | 0.000909 |
| `iterations` | 6.000000 |
...
- Aircraft anchor records used: `12`; Stage4-like anchor hold-out excluded: `2`.
