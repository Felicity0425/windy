# CMA-RA Virtual Radial 3DVAR Proxy - 20260219015400
...
- Stage2 frame: `20260219015400`
- CMA time: `2026021900->2026021906` (`delta_hours=1.900`)
- CMA time method: `linear_qc`
- Stage2 npz: `/data/LFT-W02_data/pengxu/centralized_v1_output/stage2_full_v2/voxels/frame_20260219015400_multimodal.npz`
...
- NPZ: `/data/LFT-W02_data/pengxu/优化/stage4_cma_m1_light_demo_20260625/representative_cma_proxy/cma_ra_virtual_radial_3dvar_20260219015400.npz`
- sample CSV: `/data/LFT-W02_data/pengxu/优化/stage4_cma_m1_light_demo_20260625/representative_cma_proxy/cma_ra_virtual_radial_3dvar_20260219015400_sample.csv`

## Proxy Losses

| metric | value |
| --- | ---: |
| `loss_observation_fit_proxy` | 20.517113 |
| `loss_background_fit_proxy` | 0.067698 |
| `loss_stage4_sparse_prior_fit_proxy` | 0.000000 |
| `loss_virtual_radial_velocity_fit_proxy` | 0.036075 |
| `loss_smoothness_proxy` | 0.268216 |
| `loss_weak_horizontal_divergence_proxy` | 0.186625 |
| `loss_vertical_shear_proxy` | 2.060766 |
| `loss_boundary_background_proxy` | 0.005605 |
| `coverage_conf_positive_fraction` | 0.000628 |
| `iterations` | 6.000000 |
...
- Aircraft anchor records used: `10`; Stage4-like anchor hold-out excluded: `2`.
