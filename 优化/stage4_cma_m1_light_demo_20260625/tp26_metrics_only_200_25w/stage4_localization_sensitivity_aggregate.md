...
| ---: | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| 1 | `gaussian` | `diagnostic_weighted` | `pydda_3dvar_proxy` | `current_priority_adaptive` | `preserve_strong_layers` | `fixed` | 10/5.0/2/1.0 | 94 | 94 | 0 | 192 | 7.296702 | 6.319984 | 7.296702 | 95624.1 | 234246.2 | `True` | `False` |
| 2 | `gaussian` | `diagnostic_weighted` | `pydda_3dvar_proxy` | `current_priority_adaptive` | `preserve_strong_layers` | `fixed` | 8/4.0/2/1.0 | 106 | 106 | 0 | 338 | 9.046904 | 7.757578 | 9.046904 | 87832.7 | 201378.6 | `True` | `False` |
...
| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | 1723.0 | 12.757 | 0.233 | 1.000 | 1721.9 | 3191.0 | 24.0 | 4963.1 | 3194.0 | 1769.1 |
| 2 | 2117.3 | 12.263 | 0.211 | 1.000 | 1516.8 | 2869.5 | 10.7 | 4425.7 | 2872.7 | 1553.1 |
